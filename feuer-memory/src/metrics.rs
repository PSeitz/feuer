...
pub struct MemoryMetrics {
    ...
    ghost_hit: BoxedCounter,
    ghost_promotion: BoxedCounter,
...
impl MemoryMetrics {
    ...
    pub fn new(registry: &BoxedRegistry) -> Arc<Self> {
        ...
        Arc::new(Self {
            ...
            ghost_hit: operation("ghost_hit"),
            ghost_promotion: operation("ghost_promotion"),
    ...
    pub(crate) fn record_ghost_hit(&self) {
        self.ghost_hit.increase(1);
    }

    pub(crate) fn record_ghost_promotion(&self) {
        self.ghost_promotion.increase(1);
    }
...
mod tests {
    ...
    fn registers_and_updates_through_the_normal_registry_boundary() {
        ...
        metrics.record_ghost_promotion();
